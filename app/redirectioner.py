...
from app.crud import get_real_url, inject, get_url_document, is_domain_prevented, random_redirect
...
def has_extra_options(url_document):
    for prop in ["time_limit", "click_limit", "go_rougue", "not_child", "not_work", "contains_politics", "contains_promotions", "contains_violence"]:
